...
const Contacts = () => {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form   className="space-y-8" onSubmit={handleSubmit}>  
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-[#F59E0B] sm:w-fit hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form>
